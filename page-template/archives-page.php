            ...
            <section class="archives">
                ...
                <div class="fancy-archive">
                    ...
                    while ( $the_query->have_posts() ) : $the_query->the_post();
                        ...
                        $post_mon = date('M',get_the_time('U'));
                        $posts_rebuild[$post_year][$post_mon][] = '<div><a href="'. get_permalink() .'">'. get_the_title() .'</a> <em>('. get_comments_number('0', '1', '%') .')</em></div>';
                    endwhile;
                    wp_reset_postdata();
                    foreach ($posts_rebuild as $key => $value) {
                        $output .= '<div class="archives"><h3 class="archives-year">' . $key . '</h3>';
                        $year = $key;
